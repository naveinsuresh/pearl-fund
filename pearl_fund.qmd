---
title: "Pearl Fund: A Guide on Portfolio Anlaysis & Optmization"
...
This data set shows the last 5 monthly returns from 2004 to 5 years prior to today's date.
...
We repeat the above process for the 2nd batch of monthly stock returns which lasts for the last 5 year.
...
We run a *Principal Component Analysis* calculation to display the groupings and correlations among the various assets in the pearl fund.
...
## Multiple Portfolio Performance Testing
