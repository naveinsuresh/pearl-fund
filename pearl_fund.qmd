...
stock_returns_monthly_raw <- tq_get(stock_tickers, get  = "stock.prices", from = "2004-01-01", to = "2019-01-01")
...
```{r}
stock_returns_monthly_test_raw <- tq_get(stock_tickers, get  = "stock.prices", from = "2019-01-01", to = Sys.Date())
...
opt_maxret <- optimize.portfolio(R=stock_returns_monthly_test_wide, portfolio=pearlfund, optimize_method="ROI", trace=TRUE)
