...
::: callout-tip
💡 Detailed Background Overview: [Pearl Fund](https://drive.google.com/file/d/1xbmX7GZ3pakPfEb3VJlRCiLe_34yudnt/view?usp=sharing)
:::
...
ggplot() +
  ...
  annotate(geom = "text", x = as.Date("2019-03-01"), y = 35000, 
           label = "Equally\nWeighted", color = "blue") +
